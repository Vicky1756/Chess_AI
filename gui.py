...
class GUI(tkinter.Frame):
    ...
    def move(self, dest_square):
        ...
        move = ROW_CHARACTER[self.start_square[1]] + str(self.start_square[0] + 1)
        move += ROW_CHARACTER[dest_square[1]] + str(dest_square[0] + 1)
    ...
    def highlight(self):
        ...
        selected_square = ROW_CHARACTER[self.start_square[1]] + str(
            self.start_square[0] + 1)

        self.highlighted_pieces = [(int(legal_move[-1]) - 1,
                                    ROW_CHARACTER.index(legal_move[2])) if
